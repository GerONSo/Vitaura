...
data class Gallery(
    @field:Json(name = "attributes") var attrs: GalleryAttributes,
...
data class GalleryFileData(@field:Json(name = "data") var data: GalleryFile)
...
data class ChangeFile(
    ...
    @field:Json(name = "field_gallery_image") var path: String
)
