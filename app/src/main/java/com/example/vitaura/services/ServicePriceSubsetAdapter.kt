...
import com.example.vitaura.prices.Price
import com.example.vitaura.prices.PriceSet
import com.example.vitaura.prices.PriceSubsetAdapter
...
class ServicePriceSubsetAdapter(groups: List<PriceSet>, var topPosition: Int) :
    ExpandableRecyclerViewAdapter<ServicePriceSubsetAdapter.PriceSubsetViewHolder, ServicePriceSubsetAdapter.PriceViewHolder>(
        groups
    ) {
