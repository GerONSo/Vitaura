...
import com.example.vitaura.prices.PriceAdapter
import com.example.vitaura.prices.PricesRepository
import com.thoughtbot.expandablerecyclerview.viewholders.ChildViewHolder
import kotlinx.android.synthetic.main.card_price.view.*

class ServicePriceAdapter (var topPosition: Int) : RecyclerView.Adapter<ServicePriceAdapter.PriceViewHolder>() {
    ...
    fun getPriceSet(pos: List<Int>): MutableList<Price>? {
        return PricesRepository.servicePrices.value?.set?.get(pos)?.second
    }
